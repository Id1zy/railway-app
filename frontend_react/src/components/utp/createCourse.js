...
const CreateCourse =({ onClose}) => {
  ...
  return (
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="text-blue">
        <div>
          <div className="grid grid-cols-1 gap-4  mb-1">
            <div>
            <p className='w-full inline-block rounded-t-lg text-xl3 mb-2 text-blue font-bold text-center'>Crear Curso</p>
              <input
                type="text"
                {...register('nivel', {
   ...
   <div className="inline-flex  items-center">
    ...
    <button 
    type="submit"
    className='bg-new-green hover:bg-new-dark-green button_tech_colorless'>Crear</button>
   </div>
   </div>
