...
<footer className="bg-light-gray dark:bg-gray-900 z-10">
    ...
    <div className="px-4 py-6 bg-gray dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-white dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">TechnoCode</a>. All Rights Reserved.
        </span>
