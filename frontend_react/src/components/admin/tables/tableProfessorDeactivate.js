...
export function TableProfessorDeactivate(props) {
  ...
  <div className="w-full max-w-md transform overflow-hidden rounded-2xl bg-admin-background p-6 text-left align-middle shadow-xl transition-all">
   <div className="w-full mb-3">
    <p className="text-white text-xl font-bold text-center">¿Estas Seguro de Acctivar al usuario {item.first_name}?</p>
   </div>
