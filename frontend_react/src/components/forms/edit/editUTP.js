...
import { getUTP, editUTP } from "../../../api/axiosUTP";



const EditUTP =({id, onClose}) => {
  ...
  const onSubmit = (data) => {
    if (password !== re_password) {
      ...
      editUTP(id, data['first_name'], data['last_name'], data['email'],  data['password'], )
