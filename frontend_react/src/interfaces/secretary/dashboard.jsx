...
import { SecretaryRoutes } from "../../helpers/users_routes";
import { Link } from "react-router-dom";



const DashboardSecretary = ({isAuthenticated, user}) => {
  ...
  if(!isAuthenticated){
    ...
    return(
        <PageUser color={'bg-white text-blue'} colorInput={'bg-white text-blue'} >
          <SideBar color={'bg-blue'} useRol={'secretario'} mapeo={secretary_maps} >
            {/* Parte Central */}
        ...
        <div className="animate-pulse">
          ...
          <div className="bg-white shadow rounded-[20px] p-3">
                  ...
                  <div className="flex justify-center  mt-3">
                      ...
                      <Link to={SecretaryRoutes.Dashboard} className="w-full bg-new-green hover:bg-deep-green button_tech_5 ">click</Link>
                  </div>
              </div>
