  ...
  const mapping = index_maps
    ...
    return(
        ...
        <PageUser color={'bg-white text-blue'} colorInput={'bg-white text-blue'} >
          <SideBar color={'bg-blue'} userData={index_maps} useRol="Estudiante" mapeo={mapping}>
            {/* Parte Central */}
          ...
          <li key={activityItem.id}>
            <div className="relative pb-8">
              {activityItemIdx !== activity.length - 1 ? (
                <span className="absolute left-5 top-5 -ml-px h-full w-0.5 bg-blue" aria-hidden="true" />
              ) : null}
                  ...
                  <>
                    ...
                    <div className="min-w-0 flex-1 py-1.5">
                      <div className="text-sm text-gray-500">
                        <a href={activityItem.person.href} className="font-medium text-blue">
                          {activityItem.person.name}
                        </a>{' '}
                        assigned{' '}
