...
import AttendanceCourse from "../../components/heros/attendanceCoursesCard";
import SearchBar from "../../components/heros/searchBarDirector";

const DirectorAtendanceList = () => {
        ...
        <div className="w-full bg-fondo p-4 h-full overflow-y-auto">
          <div className="mx-auto max-w-7xl mt-1">
            <div className="grid grid-cols-1 gap-1 mb-5">
              <PageHeading colorText={'text-blue'} border={'border-blue my-0'} title='Registro de Asistencia' />
...
export default DirectorAtendanceList;
