...
<div
        ...
        <div className="flex items-center">
            <Link to={GuardianRoutes.Forum.replace(':uid', params.uid)}><ArrowLeftIcon className="h-6 w-6 text-blue hover:text-white hover:rounded-full hover:bg-blue"/></Link>
...
<div className="bg-admin-green px-3 py-1 rounded-full text-xs font-medium  hidden md:block">
      ...
      {comment.map((item)=>(
        ...
        <div className="flex-shrink-0">
           ...
           {item.avatar ? <>
        <img src={`http://localhost:8000${item.avatar}` } alt="tailwind logo" className="inline-block h-10 w-10 rounded-full" /></> :
      <>
      <img
         ...
         <div className=" flex-1">
           ...
           <div className="my-2 text-blue font-bold">{item.Parent.title}</div>
           </div>
          ...
          <div className="flex-shrink-0">
          {it.subSon.avatar ? <>
        <img src={`http://localhost:8000${it.subSon.avatar}` } alt="tailwind logo" className="inline-block h-10 w-10 rounded-full" /></> :
      <>
      <img
             className="inline-block h-10 w-10 rounded-full"
             src={ProfileImg}
