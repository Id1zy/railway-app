...
//Others
import { gurdian_maps } from "../../helpers/users_helpers";
              ...
              <Disclosure.Panel className="px-2 pt-2 pb-4 text-sm text-gray-500">
                ...
                {item.Files.map((item_, index_)=>(<>
                  <div className="inline-flex m-1 justify-between items-center ">
                    ...
                    <Link to={ProfessorRoutes.EditFiles.replace(':uid', params.uid).replace(':file', item_.file.id)} className='bg-blue button_tech_colorless hover:bg-light-blue !px-2 !text-xs'>
            Configurar
          </Link>
                    </div>
