...
//Componentsassword } from "../../redux/actions/auth";
//Components
import PageUser from "../../hocs/layouts/PageUser";
import SideBar from "../../components/users/sidebar";
import { ArrowLeftIcon } from "@heroicons/react/24/outline";
import { PublicRoutes, ProfessorRoutes } from "../../helpers/users_routes";
// Images
...
const ProfessorSettings = ({  user, set_password, loading, logout }) => {
  const [profileImage, setProfileImage] = useState(null);
    ...
    const onSubmitImage = e =>{
        e.preventDefault();
        if(image !== null && image !== profileImage){
          put_avatar(image);
          setSuccess(true);
    ...
    if (success){
        return <Navigate to={ProfessorRoutes.Profile}/>
    }
  ...
  <Dotloader color="white" size="20" />
    ...
    <div className="flex items-center">
            <Link to={ProfessorRoutes.Profile}><ArrowLeftIcon className="h-6 w-6 text-blue hover:text-white hover:rounded-full hover:bg-blue"/></Link>
