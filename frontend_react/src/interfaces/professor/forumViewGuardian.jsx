...
const ForumViewGuardianProfessor = ({  user }) => {
        ...
        <div className={`w-full bg-white flex flex-col flex-grow p-3`}>
          ...
          <div className={`flex justify-between item-center`}>
            <div className={`flex items-center`}>
              <Link to={ProfessorRoutes.ForumGuardian.replace(':uid', params.uid)}>
                <ArrowLeftIcon className={`h-6 w-6 ${Style.textSchool} hover:text-white hover:rounded-full hover:${Style.colorSchool}`} />
              </Link>
            </div>
          ...
          <div className={`flex justify-between item-center`}>
            <div className={`flex items-center`}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor"
                className={`w-5 h-5 text-background-orange`}>
