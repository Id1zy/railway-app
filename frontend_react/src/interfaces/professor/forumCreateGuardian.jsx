...
import CreateForumGuardian from "../../components/forms/create/createForumGuardian";


const ForumCreateGuardian = ({  user }) => {
    ...
    return(
      ...
      <SideBar color={`${Style.colorSchool}`} userData={userData} useRol="Profesor" mapeo={profesor_maps}>
          <div className="w-full md:w-4/5 bg-fondo p-4 h-full shadow-md overflow-y-auto">
            <CreateForumGuardian update={()=>setUpdate(update+1)}/>
          </div>
          </SideBar>
        </PageUser>
